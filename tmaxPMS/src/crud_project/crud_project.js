Top.Controller.create('layout1_Logic', {
  ...
  r_project: function(event, widget) {
	  ...
	  $.ajax({
        url: 'http://192.168.6.68:18088/common/common_sg/ReadProjectList?action=SO',
        type: 'POST',
        dataType: 'json',
        ...
        success: function(result) {
          ...
          DR_project.DI_project_list=dto.ProjectDOList
          tv = Top.Dom.selectById("project_list");
          tv.update();
        },
  ...
  d_project: function(event, widget) {
	  ...
	  $.ajax({
        url: 'http://192.168.6.68:18088/common/common_sg/DeleteProject?action=SO',
        type: 'POST',
        dataType: 'json',
        contentType: 'application/json; charset=UTF-8',
        data: JSON.stringify({
          "dto": {
					"PROJECT_NO":tableObj.getCheckedData()[0].PROJECT_NO
